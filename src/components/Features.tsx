      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="card-hover animate-fade-in transition-all duration-300" style={{animationDelay: `${index * 100}ms`}}>
              <CardHeader>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-md overflow-hidden animate-fade-in" style={{animationDelay: "500ms"}}>
          <div className="grid md:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-brand-purple to-brand-blue text-white p-8 md:p-12 flex flex-col justify-center animate-fade-in" style={{animationDelay: "700ms"}}>
              ...
              <div className="bg-white/20 rounded-lg p-4 mb-6 animate-fade-in transition-all duration-300 hover:bg-white/30" style={{animationDelay: "900ms"}}>
                <div className="text-3xl font-bold mb-2">₹299</div>
                <div>per month, billed monthly</div>
                <div className="text-sm mt-1">or ₹2,499/year (save 30%)</div>
              </div>
              <button className="bg-white text-brand-purple hover:bg-white/90 font-medium py-2 px-4 rounded-lg transition-colors hover:scale-105 transform duration-300">
